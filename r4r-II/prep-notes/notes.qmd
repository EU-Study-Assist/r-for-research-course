...
#### Plain-text data
Plain text are flat files and is one of the most common form in which data is stored. You can use base R's util package to handle importation of data or external libraries. In this course we will be making use of external libraries, specifically the `readr` package. To install `readr`, copy and run the code belw:
