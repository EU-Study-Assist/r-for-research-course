...
- Calculate the total revenue potential for each country for each fruit
- calculate the total revenue for ZFS store
- calculate the total cost of products
- Calculate the total profit potential for each country
